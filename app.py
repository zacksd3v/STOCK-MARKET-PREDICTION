...
if not data.empty:
    # Converting to float to avoid Series formatting error
...
with st.spinner('Generating Graphs and Predictions...'):
    st.subheader('Price vs Moving Average 50 (MA50)')
...
st.markdown("---")
st.caption(f"© 2026 | {stock} Price Prediction System | Developed by Suleiman Jafar Danyaro")